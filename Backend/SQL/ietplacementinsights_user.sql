...
CREATE TABLE `user` (
  ...
  `github_profile` varchar(200) DEFAULT NULL,
  `coding_profile` varchar(200) DEFAULT NULL,
  ...
  UNIQUE KEY `github_profile` (`github_profile`),
  UNIQUE KEY `coding_profile` (`coding_profile`),
